...
This Script Created By SatzzDev 
please dont remove this        
contact me:
Instagram: @krniwnstria
Github: @KurniawanSatria
Telegram: @SatzzDev
...
console.log(chalk.blue(` ‎ ‎ Siesta - Multi Device`));
...
console.log(chalk.cyan(' ‎ ‎ Twitter : https://twitter.com/SatzzDev'));
console.log(chalk.cyan(' ‎ ‎ Instagram: https://instagram.com/SatzzDev'));
console.log(chalk.white(' ‎ ‎ _____________________________________\n'));
